...
if ($_POST) {
    ...
    if ($tempdiff < 1)
    {
        $errors['ticket_book3'] = "Cannot book ticket moive is already shown";
    }
    $a = $_POST['ticket_book'];
    $user_id = $result4['user_id'];
    ...
    echo gettype($result1['ticket_left']);
            ...
            <form action=# method = "post" class="form-horizontal"  target = "">
                <div class="card-body col-sm-6">
                    ...
                    <div class="form-group text-left">
                        ...
                        <p class="error_red"><?php if (isset($errors['ticket_book3'])) echo $errors['ticket_book3']; ?></p>
                        <br>
                        <br>
