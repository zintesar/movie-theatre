...
<div class="container">
    <table class="table table-striped">
          ...
          <tr>
              ...
              <td>
                  <a class="btn btn-info"  href="accept_payment.php?id=<?php echo $userrow['invoice_id']; ?>"> pay for ticket </a>  						
