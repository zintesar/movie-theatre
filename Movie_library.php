    ...
    <table class="table table-striped">
          ...
          <tr>
              ...
              <td>
                ...
                <a class="btn btn-info"  href="edit_movie.php?id=<?php echo $userrow['movie_id']; ?>"> edit movie </a> 							
                <a class="btn btn-info"  href="delete_movie.php?id=<?php echo $userrow['movie_id']; ?>" onclick="return confirm('Are you sure you wish to delete this Record?');">
